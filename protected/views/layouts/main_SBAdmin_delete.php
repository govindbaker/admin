      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="setup"><i class="fa fa-bar-chart-o"></i> Competition Setup</a></li>
            <li><a href="stats"><i class="fa fa-table"></i> Stats/Analytics</a></li>
            <li><a href="entries"><i class="fa fa-edit"></i> Entries</a></li>
            <li><a href="account"><i class="fa fa-font"></i> Account</a></li>
